...
-- ============================================================
-- Database 8: products_db (product-service)
-- ============================================================
...
INSERT INTO milk_products (name, description, price, quantity, unit, image_url, active) VALUES
  ('Full Cream Milk', 'Rich and creamy full cream milk', 60.0, 100, 'Liter', '', true),
  ('Toned Milk', 'Low-fat toned milk', 50.0, 100, 'Liter', '', true),
  ('Double Toned Milk', 'Extra low-fat milk', 45.0, 100, 'Liter', '', true),
  ('Skimmed Milk', 'Fat-free skimmed milk', 40.0, 100, 'Liter', '', true),
  ('Curd', 'Fresh thick curd', 30.0, 50, 'Packet', '', true),
  ('Buttermilk', 'Spiced buttermilk', 20.0, 50, 'Packet', '', true),
