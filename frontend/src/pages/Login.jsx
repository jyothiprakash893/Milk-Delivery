      ...
      <div className="animate-fade-in-up" style={{ width: '420px', maxWidth: '100%', position: 'relative', zIndex: 1 }}>
        <div className="glass-card" style={{ padding: '2.5rem 2rem', borderRadius: '24px' }}>
          ...
          <div className="text-center mb-4">
            ...
            <h4 className="fw-bold mb-1" style={{ color: 'var(--dark)', fontSize: '1.4rem' }}>ENK's MILK</h4>
            <p className="text-muted" style={{ fontSize: '0.85rem' }}>Fresh milk, delivered daily</p>
          </div>
          ...
          <div className="d-flex align-items-center gap-2 my-3">
            ...
            <span style={{ color: '#94a3b8', fontSize: '0.75rem', fontWeight: 600, letterSpacing: '0.03em' }}>OR</span>
            <div style={{ flex: 1, height: 1, background: '#e2e8f0' }}></div>
          </div>

          <a href="http://localhost:8089/oauth2/authorization/google"
             className="btn w-100 d-flex align-items-center justify-content-center gap-2 py-2.5"
             style={{
               padding: '0.7rem 1rem', fontSize: '0.9rem', fontWeight: 600,
               background: '#fff', color: '#374151', border: '2px solid #e2e8f0',
               borderRadius: '12px', textDecoration: 'none',
               transition: 'all 0.2s'
             }}
             onMouseEnter={e => { e.target.style.borderColor = '#6366f1'; e.target.style.boxShadow = '0 2px 12px rgba(99,102,241,0.15)'; }}
             onMouseLeave={e => { e.target.style.borderColor = '#e2e8f0'; e.target.style.boxShadow = 'none'; }}>
